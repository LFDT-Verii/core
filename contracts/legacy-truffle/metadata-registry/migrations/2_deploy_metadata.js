...
const couponContractAddressV1 = require(
  `../../verification-coupon/.openzeppelin/unknown-${networkId}.json`,
).proxies[0].address;

module.exports = async (deployer) => {
  const instance = await deployProxy(
    MetadataRegistry,
    [couponContractAddressV1, map(get2BytesHash, freeCredentialTypesList)],
    { deployer },
  );
